...
export const loadSnapshotFailure = createAction('[World] Load Snapshot Failure', props<{ error: string }>());
...
export const placeOnCellFailure = createAction('[World] Place On Cell Failure', props<{ error: string }>());
